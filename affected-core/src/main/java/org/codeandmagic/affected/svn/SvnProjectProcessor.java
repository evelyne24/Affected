...
/**
 * This processor will receive information about a working copy of a svn project
 * and perform the following actions upon it:
 * <ul>
...
public interface SvnProjectProcessor {
	 ...
	 * 
	 * @param project
	 *            the {@link org.codeandmagic.affected.svn.api.SvnProject} to be
	 *            scanned for tags
	 * 
